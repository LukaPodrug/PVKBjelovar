  ...
  return (
    <div className="admin-shell min-h-screen bg-bg text-ink">
      ...
      <div className="mx-auto grid min-h-screen max-w-[1700px] grid-cols-1 gap-5 px-4 py-4 lg:grid-cols-[292px_1fr] lg:px-5 lg:py-5">
        <aside
          className={clsx(
            "fixed left-0 top-0 z-30 flex h-screen w-[304px] flex-col border-r-2 border-line bg-surface transition-transform lg:sticky lg:top-5 lg:h-[calc(100vh-2.5rem)] lg:w-auto lg:translate-x-0",
